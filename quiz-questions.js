...
var questions = [
    {
        title: "JavaScript is the programming language of the _____. ",
    ...
    {
        title: "Which symbol is used separate JavaScript statements?",
        choices: ["Comma (,)", "Colon (:)", "Hyphen (_)", "Semicolon (;)"],
        answer: "Semicolon (;)"
    },
    {
        title: "In how many ways can CSS be written in?",
        choices: ["2", "4", "3", "1"],
        answer: "3"
    },
    {
        title: "How can we select an element with a specific ID in CSS?",
...
// Calculation and display of final score
    if (countdown >= 0) {
        ...
        outOfTime.textContent = "The quiz has ended!";
